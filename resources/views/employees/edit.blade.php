    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('employees.update',$employee->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="username" type="text" class="form-control @error('username') is-invalid @enderror" name="username" value="{{ old('username',$employee->username) }}" required autocomplete="username" autofocus>
           ...
           <form method="POST" action="{{route('employees.destroy',$employee->id)}}"> 
                @csrf
                @method('DELETE')
                <button class="btn btn-danger">Delete {{$employee->username}} </button>
            </form>
           </div>
        </div> 
    </div>
